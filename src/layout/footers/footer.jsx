...
import footer_logo from "../../../public/assets/img/footer/image.png";
import footer_logo2 from "../../../public/assets/img/footer/footerLogo2.png";
import footer_logo3 from "../../../public/assets/img/footer/footerLogo3.png";
...
const Footer = () => {
   ...
   return (
      <>
         ...
         <footer className='footerCutom'>
            <div className='footerContainer'>
               <Image src={footer_logo} alt="" style={{
                  color: 'transparent',
                  width: '1500px',
                  padding: '0px 10px 0px 10px',
                  height: '110px'
               }} /><br />
               <Image src={footer_logo2} alt="" style={{
                  padding: '0px 10px 0px 10px',
                  width: '235px', 
                  marginLeft:"14px",
                  marginTop:"10px"
               }} />
               <Image src={footer_logo3} alt="" style={{
                  color: 'transparent',
                  width: '88px',
                  marginLeft: '1126px',
                  height: '45px',
