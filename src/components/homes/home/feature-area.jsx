...
const feature_content = {
   title: "A single hub that tackles all your problems",
   sub_title: "Simplifying your Input tax credit, one problem at a time",
}
               ...
               <div className="row justify-content-center">
                  <div className="col-xl-6 wow tpfadeUpp" data-wow-duration=".9s" data-wow-delay=".2s">
                     <div ref={titleRef} className="tp-feature__section-box tp__title_anime text-center mb-55 tp-title-anim">
                        <h2 className="tp-section-title" style={{fontSize:"45px"}}>{title}</h2>
                        <p>{sub_title}</p>
                     </div>
                  </div>
               </div>
