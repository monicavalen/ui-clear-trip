...
import hero_thumb_1 from "../../../../public/assets/img/hero/Image_1.png";
	...
	hero_title: (
		<>
			<span className="tp_title">
				<span className="child" style={{fontSize:"68px"}}>Claim GST Input Tax Credit on</span>
			</span>{" "}
			<br />
			<span>
				<span className="child"  style={{fontSize:"68px"}}>Hotel stays & Flights</span>
			</span>{" "}
		</>
	),
